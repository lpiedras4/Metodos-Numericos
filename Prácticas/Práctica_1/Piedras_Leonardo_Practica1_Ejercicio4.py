...
#Guardar arrays sensores en un diccionario iterar sobre él y obtener medias y desviaciones estandar para determinar
...
for sensor,temps in sensores.items():
  #Obtenemos el sesgo para determinar exactitud
  sesgo = mediaSensor(temps) - tempConst
  if abs(sesgo)<0.5: #Evaluamos si el sesgo es menor o mayor a 0.5 para definir si es exacto o inexacto
